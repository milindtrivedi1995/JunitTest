...
public class SericeTestImpl {
	...
	public void test() {
		...
		RenewalLeadStatusUpdateRequest request=new 

RenewalLeadStatusUpdateRequest();
		...
		assertEquals("Success", service.insertLeadStatus

(request).getStatus());
		assertEquals("Record updated successfully", 

service.insertLeadStatus(request).getFinalMessage());
	}
